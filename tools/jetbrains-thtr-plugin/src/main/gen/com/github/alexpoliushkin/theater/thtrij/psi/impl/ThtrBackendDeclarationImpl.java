...
public class ThtrBackendDeclarationImpl extends ASTWrapperPsiElement implements ThtrBackendDeclaration {

  public ThtrBackendDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitBackendDeclaration(this);
  }
