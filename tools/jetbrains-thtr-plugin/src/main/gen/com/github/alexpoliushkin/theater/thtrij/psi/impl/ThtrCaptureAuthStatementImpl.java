...
public class ThtrCaptureAuthStatementImpl extends ThtrNamedElementImpl implements ThtrCaptureAuthStatement {

  public ThtrCaptureAuthStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitCaptureAuthStatement(this);
  }
