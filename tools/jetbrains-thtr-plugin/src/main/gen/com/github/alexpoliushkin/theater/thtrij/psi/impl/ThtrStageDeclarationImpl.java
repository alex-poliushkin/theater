...
public class ThtrStageDeclarationImpl extends ASTWrapperPsiElement implements ThtrStageDeclaration {

  public ThtrStageDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitStageDeclaration(this);
  }
