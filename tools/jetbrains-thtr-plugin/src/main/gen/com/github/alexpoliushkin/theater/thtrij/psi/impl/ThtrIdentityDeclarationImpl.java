...
public class ThtrIdentityDeclarationImpl extends ASTWrapperPsiElement implements ThtrIdentityDeclaration {

  public ThtrIdentityDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitIdentityDeclaration(this);
  }
