...
public class ThtrExpectStatementImpl extends ASTWrapperPsiElement implements ThtrExpectStatement {

  public ThtrExpectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitExpectStatement(this);
  }
