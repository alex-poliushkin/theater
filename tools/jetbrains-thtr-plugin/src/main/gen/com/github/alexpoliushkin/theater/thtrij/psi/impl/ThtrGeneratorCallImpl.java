...
public class ThtrGeneratorCallImpl extends ASTWrapperPsiElement implements ThtrGeneratorCall {

  public ThtrGeneratorCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitGeneratorCall(this);
  }
