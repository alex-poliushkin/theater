...
public class ThtrCallDeclarationImpl extends ASTWrapperPsiElement implements ThtrCallDeclaration {

  public ThtrCallDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitCallDeclaration(this);
  }
