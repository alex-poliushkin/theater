...
public class ThtrRecordDeclarationImpl extends ASTWrapperPsiElement implements ThtrRecordDeclaration {

  public ThtrRecordDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
