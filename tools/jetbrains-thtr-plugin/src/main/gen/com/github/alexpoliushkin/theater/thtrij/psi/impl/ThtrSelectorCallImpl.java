...
public class ThtrSelectorCallImpl extends ASTWrapperPsiElement implements ThtrSelectorCall {

  public ThtrSelectorCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitSelectorCall(this);
  }
