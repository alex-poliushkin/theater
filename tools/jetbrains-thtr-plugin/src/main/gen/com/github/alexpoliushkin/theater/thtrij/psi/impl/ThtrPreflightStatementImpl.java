...
public class ThtrPreflightStatementImpl extends ASTWrapperPsiElement implements ThtrPreflightStatement {

  public ThtrPreflightStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitPreflightStatement(this);
  }
