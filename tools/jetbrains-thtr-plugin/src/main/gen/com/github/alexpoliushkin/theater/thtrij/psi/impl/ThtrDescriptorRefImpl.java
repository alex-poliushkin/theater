...
public class ThtrDescriptorRefImpl extends ASTWrapperPsiElement implements ThtrDescriptorRef {

  public ThtrDescriptorRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitDescriptorRef(this);
  }
