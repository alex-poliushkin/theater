...
public class ThtrTransitionStatementImpl extends ASTWrapperPsiElement implements ThtrTransitionStatement {

  public ThtrTransitionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitTransitionStatement(this);
  }
