...
public class ThtrActDeclarationImpl extends ThtrNamedElementImpl implements ThtrActDeclaration {

  public ThtrActDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitActDeclaration(this);
  }
