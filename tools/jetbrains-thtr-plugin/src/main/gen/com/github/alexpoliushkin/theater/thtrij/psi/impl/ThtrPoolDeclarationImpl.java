...
public class ThtrPoolDeclarationImpl extends ASTWrapperPsiElement implements ThtrPoolDeclaration {

  public ThtrPoolDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitPoolDeclaration(this);
  }
