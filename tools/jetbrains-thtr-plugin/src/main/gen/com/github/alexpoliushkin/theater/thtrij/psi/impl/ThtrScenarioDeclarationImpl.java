...
public class ThtrScenarioDeclarationImpl extends ThtrNamedElementImpl implements ThtrScenarioDeclaration {

  public ThtrScenarioDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitScenarioDeclaration(this);
  }
