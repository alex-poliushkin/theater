...
public class ThtrSessionDeclarationImpl extends ASTWrapperPsiElement implements ThtrSessionDeclaration {

  public ThtrSessionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitSessionDeclaration(this);
  }
