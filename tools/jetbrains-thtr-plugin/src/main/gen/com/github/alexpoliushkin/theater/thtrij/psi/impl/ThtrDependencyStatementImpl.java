...
public class ThtrDependencyStatementImpl extends ASTWrapperPsiElement implements ThtrDependencyStatement {

  public ThtrDependencyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitDependencyStatement(this);
  }
