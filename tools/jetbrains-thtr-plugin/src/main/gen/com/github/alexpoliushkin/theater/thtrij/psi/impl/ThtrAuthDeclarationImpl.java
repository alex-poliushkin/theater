...
public class ThtrAuthDeclarationImpl extends ASTWrapperPsiElement implements ThtrAuthDeclaration {

  public ThtrAuthDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThtrVisitor visitor) {
    visitor.visitAuthDeclaration(this);
  }
